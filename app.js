...
const totalStatus = (totalObject) => {
  return {
    totalCases: districtObject.cases,
    totalCured: districtObject.cured,
    totalActive: districtObject.active,
    totalDeaths: districtObject.deaths,
  };
};
...
//     WHERE
//       state_id = ${stateId};`;
//     const dbResponse = await db.all(getStateStatusQuery);
//     response.send(
//         dbResponse.map((forEach) =>
//         totalStatus(forEach)
//         )
//     );
// });
